...
public struct InsulinModelSelection: View {
    ...
    private func oneUnitBolusEffectPrediction(using model: InsulinModel) -> [GlucoseValue] {
        ...
        let effects = [bolus].glucoseEffects(insulinModelInfo: InsulinModelInfo(defaultInsulinModel: model), longestEffectDuration: model.effectDuration, insulinSensitivity: insulinSensitivitySchedule)
