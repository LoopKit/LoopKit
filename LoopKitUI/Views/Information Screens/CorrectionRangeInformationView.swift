...
public struct CorrectionRangeInformationView: View {
    ...
    private var text: some View {
        VStack(alignment: .leading, spacing: 25) {
            ...
            + Text("safety").bold()
            + Text(String(format:  LocalizedString(" setting. For this range, choose the specific glucose value (or range of values) that you want %1$@ to aim for in adjusting your basal insulin. This will be a narrower range.", comment: "Information about correction range format (1: app name)"), appName))
