    ...
    private func description(for preset: CorrectionRangeOverrides.Preset) -> some View {
        ...
        case .preMeal:
            return VStack(alignment: .leading, spacing: 20) {
                Text(String(format: LocalizedString("Your Pre-Meal Preset should be the glucose value (or range of values) you want %1$@ to target by the time you take your first bite of your meal. This correction range will be in effect when you activate the Pre-Meal preset.", comment: "Information about pre-meal range format (1: app name)"), appName))
