//
//  RemoteOverrideActionTests.swift
//  LoopKitTests
//
...
final class RemoteOverrideActionTests: XCTestCase {
    ...
    func testToValidOverride_Succeeds() throws {
        ...
        let action = RemoteOverrideAction(name: overrideName, durationTime: durationTime, remoteAddress: remoteAddress)
    ...
    func testToValidOverride_WhenOverrideNotInPresets_Fails() throws {
        ...
        //Arrange
        let action = RemoteOverrideAction(name: "Unknown-Override", durationTime: TimeInterval(hours: 1.0), remoteAddress: "1234-54321")
        ...
        //Assert
        guard let validationError = thrownError as? RemoteOverrideActionError, case .unknownPreset = validationError else {
    ...
    func testToValidOverride_WhenNoDuration_YieldsIndefiniteOverride() throws {
        ...
        //Arrange
        let action = RemoteOverrideAction(name: "My-Override", durationTime: nil, remoteAddress: "1234-54321")
        let presets = [TemporaryScheduleOverridePreset(symbol: "", name: "My-Override", settings: .init(targetRange: .none), duration: .indefinite)]
    ...
    func testToValidOverride_WhenDurationZero_YieldsIndefiniteOverride() throws {
        ...
        //Arrange
        let action = RemoteOverrideAction(name: "My-Override", durationTime: TimeInterval(hours: 0), remoteAddress: "1234-54321")
        let presets = [TemporaryScheduleOverridePreset(symbol: "", name: "My-Override", settings: .init(targetRange: .none), duration: .indefinite)]
    ...
    func testToValidOverride_WhenNegativeDuration_Fails() throws {
        ...
        //Arrange
        let action = RemoteOverrideAction(name: "My-Override", durationTime: TimeInterval(hours: -1.0), remoteAddress: "1234-54321")
        let presets = [TemporaryScheduleOverridePreset(symbol: "", name: "My-Override", settings: .init(targetRange: .none), duration: .indefinite)]
        ...
        //Assert
        guard let validationError = thrownError as? RemoteOverrideActionError, case .negativeDuration = validationError else {
            XCTFail("Unexpected type \(thrownError.debugDescription)")
            return
        }
    }
    ...
    func testToValidOverride_WhenAtMaxDuration_Succeeds() throws {
        ...
        let action = RemoteOverrideAction(name: "My-Override", durationTime: duration, remoteAddress: "1234-54321")
        let presets = [TemporaryScheduleOverridePreset(symbol: "", name: "My-Override", settings: .init(targetRange: .none), duration: .indefinite)]
    ...
    func testToValidOverride_WhenAtMaxDuration_Fails() throws {
        ...
        //Assert
        guard let validationError = thrownError as? RemoteOverrideActionError, case .durationExceedsMax = validationError else {
            XCTFail("Unexpected type \(thrownError.debugDescription)")
            return
        }
    }
