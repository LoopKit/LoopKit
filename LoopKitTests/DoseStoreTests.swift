...
class DoseStoreTests: PersistenceControllerTestCase {
    ...
    func testSplitBasalsSyncedToHealth() {
        ...
        healthStore.setSaveHandler({ (objects, success, error) in
            ...
            XCTAssertEqual(0.0026666666666666666, temp1.quantity.doubleValue(for: .internationalUnit()), accuracy: .ulpOfOne)
            ...
            XCTAssertEqual(0.04725, temp2.quantity.doubleValue(for: .internationalUnit()), accuracy: .ulpOfOne)
            XCTAssertNil(error)
            addPumpEvents3.fulfill()
        })
        doseStore.insulinDeliveryStore.test_lastBasalEndDateDidSet = {
        ...
        healthStore.setSaveHandler({ (objects, success, error) in
            ...
            XCTAssertEqual(0.025083333333333332, temp.quantity.doubleValue(for: .internationalUnit()), accuracy: .ulpOfOne)
            XCTAssertNil(error)
